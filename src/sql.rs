...
WHERE
  ...
  pub const GET_ALL_CATEGORIES:&str ="select * from categories order by parent, id";
  pub const GET_ROOT_CATEGORIES:&str ="select * from categories where parent is null order by id";
